...
namespace System.Reactive.Concurrency
{
  ...
  /// </summary>
  /// <remarks>
  /// This scheduler type is typically used indirectly through the <see cref="Linq.DispatcherObservable.ObserveOnDispatcher{TSource}(IObservable{T})"/> and <see cref="Linq.DispatcherObservable.SubscribeOnDispatcher{TSource}(IObservable{TSource})"/> methods that use the current Dispatcher.
  /// </remarks>
  public sealed class CoreDispatcherScheduler : LocalScheduler, ISchedulerPeriodic
  {
    ...
    public static CoreDispatcherScheduler Current
    {
      get
      {
        ...
        if (window == null)
        {
          throw new InvalidOperationException("NO_WINDOW_CURRENT");
        }
