...
static void TryModelWithTableAttribute(string connectionString)
{
...
static async Task AddOrUpdateProduct(string connectionString)
{
...
static async Task<RedisSubscriber> CreateRedisSubscriber(string redisUrl)
{
...
static async Task DeleteAllAsync(string connectionString)
{
  var optionsBuilder = new DbContextOptionsBuilder<SampleDbContextCore>();
  optionsBuilder.UseSqlServer(connectionString);
